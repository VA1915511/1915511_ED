Ahora voy hablar sobre JAVASCRIPT JavaScript se puede usar tanto en el lado del cliente (navegador web) como en el lado del servidor (Node.js), lo que significa que puedes escribir 
